...
#
# OpenCode is deliberately thin. It carries only the rules that change what it
# does on every task; the rest would be prompt weight for no behaviour. Widen its

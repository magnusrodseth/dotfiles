...
```bash
cmux send --surface "$S" 'Codex -p "your question" | tee /tmp/out.txt; echo DONE >> /tmp/out.txt\n'
...
The robust, most-secure setup is to run the orchestrator as a Codex launched

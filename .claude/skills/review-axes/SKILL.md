...
<!-- Vendored from mattpocock/skills @ skills/in-progress/review/SKILL.md.
     Renamed from `review` → `review-axes` to avoid colliding with the built-in
     /review command. Update by re-fetching from the upstream repo. -->
